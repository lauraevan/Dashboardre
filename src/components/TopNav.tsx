    ...
    <nav style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginRight: 38 }}>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
          <circle cx="10" cy="10" r="8" stroke="#4ec8d8" strokeWidth="1.5" fill="none"/>
        ...
        <span style={{ fontSize: 14.5, fontWeight: 600, color: '#4ec8d8', letterSpacing: '-0.02em' }}>Goodcast</span>
        <span style={{
          fontSize: 8.5, fontWeight: 700, letterSpacing: '0.08em', color: '#4ec8d8',
          border: '1.5px solid #4ec8d8', borderRadius: 3, padding: '1px 4px',
          lineHeight: '13px', textTransform: 'uppercase',
        }}>TURBO</span>
      </div>
            ...
            <div key={link} style={{ position: 'relative', padding: '0 15px', height: 56, display: 'flex', alignItems: 'center' }}>
              ...
              {active && (
                <div style={{
                  ...
                  transform: 'translateX(-50%)', width: 48, height: 2,
                  background: 'var(--text)', borderRadius: '1px 1px 0 0',
                }} />
              )}
            </div>
          )
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{
          display: 'flex', alignItems: 'center', height: 32, width: 192,
          border: '1px solid var(--border)', borderRadius: 5,
          background: 'var(--surface)', padding: '0 9px', gap: 7,
        }}>
        ...
        <button style={{
          height: 32, padding: '0 12px', border: '1px solid var(--border)', borderRadius: 5,
          ...
          <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
            <path d="M5.5.9l1.1 2.5 2.5.2-1.9 1.7.6 2.5L5.5 6.6 3.2 7.8l.6-2.5L2 3.6l2.4-.1L5.5.9z" fill="#4ec8d8"/>
          </svg>
